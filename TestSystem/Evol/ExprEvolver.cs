...
namespace TestSystem.Evol
{
    public abstract class ExprEvolver
    {
        ...
        protected void SetupConstantFunctions()
        {
            // Constant functions
            for (int i = 0; i < 20; i++)
            {
                exps.Add(GetConstantFunction());
            }
        }

        protected extree GetConstantFunction()
        {
            extree temp;
        ...
        protected void SetupXFunctions()
        {
            // X functions
            for (int i = 0; i < 20; i++)
            {
                exps.Add(GetXFunction());
            }
        }
